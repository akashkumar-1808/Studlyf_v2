                                      ...
                                      {visualizerState.nodes.map((node: any) => {
                                        ...
                                        return (
                                          <motion.div
                                            ...
                                            className={`absolute w-10 h-10 rounded-full flex items-center justify-center font-black text-xs border-2 shadow-2xl transition-all ${currentNode
                                      ...
                                      <div className="flex gap-3 relative py-4">
                                        {visualizerState.chars.map((char: string, idx: number) => {
                                          ...
                                          return (
                                            <div
                                              key={idx}
                                              className={`w-12 h-12 rounded-xl border flex flex-col items-center justify-center font-black transition-all relative ${isConflict
                                      ...
                                      {visualizerState.nodes.map((node: number, idx: number) => {
                                        ...
                                        return (
                                          <React.Fragment key={idx}>
                                            <div
                                              className={`w-12 h-12 rounded-full border-2 flex items-center justify-center font-black transition-all relative ${isCurr
                                        ...
                                        {Array(visualizerState.n).fill(null).map((_, r) => (
                                          Array(visualizerState.n).fill(null).map((_, c) => {
                                            ...
                                            return (
                                              <div
                                                key={`${r}-${c}`}
                                                className={`w-9 h-9 rounded-lg border text-[10px] font-mono flex items-center justify-center transition-all ${isActiveCell
                                        ...
                                        return (
                                          <div key={idx} className="flex flex-col items-center">
                                            <div
                                              ...
                                              className={`w-10 rounded-t-xl transition-all flex items-center justify-center font-black text-xs ${isPivot
                                      ...
                                      {visualizerState.nodes.map((node: any) => {
                                        ...
                                        return (
                                          <motion.div
                                            key={node.id}
                                            style={{ left: node.x - 20, top: node.y - 20 }}
                                            className={`absolute w-10 h-10 rounded-full flex flex-col items-center justify-center font-black text-xs border-2 shadow-2xl transition-all ${nodeState === 'processing'
                                              ? 'bg-yellow-500 border-yellow-300 text-slate-900 scale-125 z-20 shadow-yellow-500/50'
                                              : nodeState === 'processed'
                              ...
                              <div className="bg-[#120B2E] border border-gray-200 rounded-[2rem] p-6 lg:p-8 flex flex-col items-center justify-center text-center shadow-2xl relative">
                                ...
                                {showImprovementList && (
                                  <div className="mt-6 w-full text-left bg-gray-100/40 p-4 rounded-xl border border-white/[0.02] text-xs text-slate-400 space-y-2.5">
                                    ...
                                    <div className="flex gap-2 items-start"><Check className="w-4 h-4 text-purple-400 flex-shrink-0" /> <span>Add more metrics-driven achievements (e.g. Optimized speed by 25%).</span></div>
                                  </div>
                                )}
                              </div>
